subroutine estimate_parameters(K,T,Y0,method,optim_mode,lin_mode,options,mu_a,cov_a,mu,cov)
    !
        ...
        case ('ssTauLeap')
            ...
            do i = 2,K
                ...
                select case ( optim_mode )
                    case ( 'unc' )
                        residual = gradsearch( 3*num_reactions, ss_residual, params, N_steps=100, MaxIter=100 )
